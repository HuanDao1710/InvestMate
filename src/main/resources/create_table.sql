CREATE TABLE IF NOT EXISTS listing_companies ( -- danh sách công ty
 ...
 CREATE TABLE IF NOT EXISTS companies_info ( -- thông tin công ty
 	ticker varchar(8) unique,
...
CREATE TABLE IF NOT EXISTS stock_history ( -- lịch sử giao dịch
 	ticker varchar(3),
...
CREATE TABLE IF NOT EXISTS income_statement ( -- báo cáo thu nhập
 	ticker varchar(3),
 	year integer,
 	quarter integer,
 	revenue integer,
...
CREATE TABLE IF NOT EXISTS balance_sheet ( -- cân đối kế toán
 	ticker varchar(3),
 	year integer,
 	quarter integer,
...
CREATE TABLE IF NOT EXISTS cash_flow ( -- Dòng tiền
 	ticker varchar(3),
 	year integer,
 	quarter integer,
 	invest_cost integer,
...
CREATE TABLE IF NOT EXISTS financial_ratio ( -- tỉ lệ tài chính
 	ticker varchar(3),
 	year integer,
 	quarter integer,
...
CREATE TABLE IF NOT EXISTS stock_intraday_transaction ( -- giao dịch cổ phiếu trong ngày
 	id serial,
...
CREATE TABLE IF NOT EXISTS general_rating ( -- đánh giá chung
 	ticker varchar(8),
	year integer,
 	quarter integer,
 	stock_rating double precision,
...
CREATE TABLE IF NOT EXISTS business_model_rating ( -- đánh giá mô hình kinh doanh
 	ticker varchar(8),
	year integer,
 	quarter integer,
 	business_model double precision,
...
CREATE TABLE IF NOT EXISTS business_operation_rating ( -- đánh giá hoạt động kinh doanh
 	ticker varchar(8),
	year integer,
 	quarter integer,
 	industry_en varchar(256),
...
CREATE TABLE IF NOT EXISTS valuation_rating ( --đánh giá giá trị
 	ticker varchar(8),
	year integer,
 	quarter integer,
 	industry_en varchar(256),
	...
	CREATE TABLE IF NOT EXISTS financial_health_rating ( -- đánh giá sức khoẻ tài chính
 	ticker varchar(8),
	year integer,
 	quarter integer,
 	industry_en varchar(256),
